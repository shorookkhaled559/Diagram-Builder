    ...
    addRowBtn.addEventListener("click", () => {
      ...
      row.classList.add("flex", "flex-col", "sm:flex-row", "sm:space-x-2", "space-y-2", "sm:space-y-0");
      row.innerHTML = `
        <input type="text" placeholder="From" class="from flex-1 border p-2 rounded" />
        <input type="text" placeholder="To" class="to flex-1 border p-2 rounded" />
      `;
    ...
    generateBtn.addEventListener("click", async () => {
      ...
      resultDiv.innerHTML = "<p class='text-gray-600 italic'>Generating diagram...</p>";
      showMessage("");
